...
@Component({
  selector: 'eg-vat-journal-detail',
  templateUrl: './vat-journal-detail.component.html',
  styleUrls: ['./vat-journal-detail.component.scss']
})
export class VatJournalDetailComponent {
  ...
  ngOnInit(){
    ...
    this.fp = Accounting.getVatJournalFormProperties();
    ...
    this.config = {
      ...
      itemId        : _itemId,
      detailsApi$     : (param, method, nextUrl)   => this._crm.vat_journals(param, method, nextUrl),
