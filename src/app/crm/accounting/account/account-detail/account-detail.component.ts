...
export class AccountDetailComponent {
  ...
  ngOnInit(){
    ...
    this.fp = Accounting.getStandardFormProperties();
    ...
    this.config = {
      ...
      header: Core.Localize('account'),
      params: {...this.params, limit: 100},
      itemId        : _itemId,
      detailsApi$     : (param, method, nextUrl)   => this._crm.account_standards(param, method, nextUrl),
