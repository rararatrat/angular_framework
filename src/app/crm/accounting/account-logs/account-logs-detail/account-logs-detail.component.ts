...
@Component({
  selector: 'eg-account-logs-detail',
  templateUrl: './account-logs-detail.component.html',
  styleUrls: ['./account-logs-detail.component.scss']
})
export class AccountLogsDetailComponent {
  ...
  ngOnInit(){
    ...
    this.fp = Accounting.getLogsFormProperties();
    ...
    this.config = {
      ...
      itemId        : _itemId,
      detailsApi$     : (param, method, nextUrl)   => this._crm.account_logs(param, method, nextUrl),
