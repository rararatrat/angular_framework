    ...
    public static getFormProperties(): {formProperties: objArrayType, formStructure: (FormStructure | any)[]}{
        ...
        const _toReturn   : {formProperties: objArrayType, formStructure: (FormStructure | string)[]} = {
          ...
          formStructure   : [
                              {
                                key       : "details",
                                header    : Core.Localize('item_details', {item: Core.Localize('delivery')}),
                                subheader : Core.Localize('enter_key_info', {item: Core.Localize('delivery')}),
                                fields    : ["name", "company","contact", "user"],
                                isTwoLine : false
                              },
                              {
                                key       : "items",
                                header    : Core.Localize('item', {count: 2}),
                                subheader : Core.Localize('list_of_products', {item: Core.Localize('delivery')}),
                                fields    : [ "files"],
                                isTwoLine : false
                              },
                              {
                                ...
                                subheader : Core.Localize('conditions_desc', {item: Core.Localize('delivery')}),
                                fields    : ["is_valid_from","is_valid_until"],
                                isTwoLine : false
                              },
                              {
                                key       : "address",
                                header    : Core.Localize('address'),
                                subheader : Core.Localize('delivery_and_invoice', {item: Core.Localize('delivery')}),
                              ...
                              },
                              {
                               ...
                               subheader : Core.Localize('settings_desc'),
                                fields    : ["bank_account", "currency", "mwst_type", "mwst_is_net"],
                                isTwoLine : false
                              },
                            ]
        }
