...
@Component({
  selector: 'eg-purchase-order-detail',
...
export class PurchaseOrderDetailComponent {
  ...
  public loading = true;
  public fp: {formProperties: objArrayType, formStructure: (string | FormStructure)[],requiredFields:string[]};
  ...
  ngOnInit(){
    ...
    this.fp = Purchasing.getPurchaseOrderProperties();
    ...
    this.config = {
      ...
      itemId        : _itemId,
      detailsApi$     : (param, method, nextUrl)   => this._crm.purchase_orders(param, method, nextUrl),
      ...
      formProperty: {
        ...
        requiredFields: this.fp.requiredFields,
      },
    }
